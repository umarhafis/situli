@section('title', 'Tambah Data Dikerjakan')
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Tambah Dikerjakan</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('dikerjakan.index') }}">Dikerjakan</a></li>
                            <li class="breadcrumb-item active">Tambah Dikerjakan</li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-lg-10 col-md-12">
                        <div class="card shadow-lg border-0">
                            <div class="card-header text-white text-center py-4 bg-gradient-custom">
                                <h3 class="mb-0">Form Pembuatan Dikerjakan</h3>
                            </div>
                            <div class="card-body p-5">
                                <form class="row g-4" method="POST" action="{{ route('dikerjakan.store') }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="col-md-6">
