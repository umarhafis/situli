@section('title', 'Perbarui Data Portofolio')
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Edit Portofolio</h3>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-lg-10 col-md-12">
                        <div class="card shadow-lg border-0">
                            <div class="card-header text-white text-center py-4 bg-gradient-custom">
                                <h3 class="mb-0">Form Perbaruhan Portofolio</h3>
                            </div>
                            <div class="card-body p-5">
                                <form class="row g-4" method="POST" action="{{ route('portofolios.update', $portofolio->id) }}" enctype="multipart/form-data">
                                    @method('PUT')
                                    @csrf
                                    <div class="col-md-6">
                                        <label for="namaPaket" class="form-label">Nama Paket Perkerjaan</label>
                                        <textarea class="form-control" id="namaPaket" name="nama_paket_perkerjaan" rows="3">{{ old('nama_paket_perkerjaan', $portofolio->nama_paket_perkerjaan) }}</textarea>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <textarea class="form-control" id="pejabatPembuatKomitmen" name="pejabat_pembuat_komitmen" rows="3">{{ old('pejabat_pembuat_komitmen', $portofolio->pejabat_pembuat_komitmen) }}</textarea>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control" id="hargaKontrak" name="harga_kontrak" rows="3">{{ old('harga_kontrak', $portofolio->harga_kontrak) }}</textarea>
                                        <div class="text-danger mt-1">{{ $errors->first('harga_kontrak') }}</div>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="lokasi" class="form-label">Lokasi</label>
                                        <input type="text" class="form-control" id="lokasi" name="lokasi" value="{{ old('lokasi', $portofolio->lokasi) }}">
                                        <div class="text-danger mt-1">{{ $errors->first('lokasi') }}</div>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="tahun" class="form-label">Tahun</label>
                                        <input type="text" class="form-control" id="tahun" name="tahun" value="{{ old('tahun', $portofolio->tahun) }}">
