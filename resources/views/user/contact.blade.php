        ...
        <div class="branding">
          ...
          <div class="container position-relative d-flex align-items-center justify-content-between">
            ...
            <ul>
                ...
                <li><a href="{{ route('contactpage') }}" class="active">Kontak</a></li>
              </ul>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="info-item d-flex flex-column justify-content-center align-items-center" data-aos="fade-up" data-aos-delay="300">
              ...
              <h3>Nomor Kami</h3>
              <p><a href="https://wa.me/6289508862423">{{ $kontaks->nomor }}</a></p>
            </div>
          </div><!-- End Info Item -->
        ...
        <div class="row gy-4 mt-1">
          <div class="col-lg-12" data-aos="fade-up" data-aos-delay="300">
            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d1186.1794944661945!2d109.3221377126737!3d-0.057100975704298895!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sid!2sid!4v1720428823175!5m2!1sid!2sid" frameborder="0" style="border:0; width: 100%; height: 400px;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
          </div><!-- End Google Maps -->
        </div>
