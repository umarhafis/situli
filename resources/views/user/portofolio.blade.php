          ...
          <div class="container position-relative d-flex align-items-center justify-content-between">
            ...
            <ul>
                ...
                <li class="dropdown"><a href="#" class="active"><span>Proyek</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
                  <ul>
                    <li><a href="{{ route('portofoliopage') }}" class="{{ request()->routeIs('portofoliopage') ? 'active' : '' }}">Portofolio</a></li>
    ...
    <section id="portofolio" class="portofolio section">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        <div class="d-flex justify-content-end mb-3">
          <a href="{{ route('download') }}" class="btn btn-danger">Unduh Portofolio</a>
        </div>
        <div class="row">
            <div class="col-12">
              <div class="table-responsive">
                            <table class="table table-fixed">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><em>Rp.{{ $portofolio->harga_kontrak }}</em></td>
                        ...
                        <div class="pagination-wrapper mt-4" data-aos="fade-up" data-aos-delay="300">
                          {{ $portofolios->links('vendor.pagination.default') }}
                      </div>
            </div>
        </div>
    </div>
