      ...
      <div class="container position-relative d-flex align-items-center justify-content-between">
        ...
        <nav id="navmenu" class="navmenu">
          <ul>
            ...
            <li><a href="{{ route('dokumentasi.view') }}"  class="active">Dokumentasi</a></li>
      ...
      <div class="container">
          <div class="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
              ...
              <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
                @foreach ($dokumentasi as $dokumentasis)
                <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
                    <div class="portfolio-content h-100">
                        <img src="{{ asset('storage/' . $dokumentasis->foto) }}" class="img-fluid" alt="{{ $dokumentasis->judul }}">
                        <div class="portfolio-info">
                            <h4>{{ $dokumentasis->judul }}</h4>
                            <p>{{ $dokumentasis->deskripsi }}</p>
                            <a href="{{ asset('storage/' . $dokumentasis->foto) }}" title="{{ $dokumentasis->judul }}" data-gallery="portfolio-gallery-app" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                        </div>
                    </div>
            ...
            <div class="pagination-wrapper mt-4" data-aos="fade-up" data-aos-delay="300">
              {{ $dokumentasi->links('vendor.pagination.default') }}
          </div>
          </div>
      </div>
  </section>
